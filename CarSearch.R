...
makeslist=sapply(makesJSON1$makes,function(x) rep(x$niceName,length(x$models)))
modelslist=sapply(makesJSON1$makes,function(x) sapply(x$models,function(y) y$id))
modelslist2=sapply(makesJSON1$makes,function(x) sapply(x$models,function(y) y$niceName))
